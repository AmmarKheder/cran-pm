...
\caption{CRAN-PM bridges the resolution gap between coarse
($\sim$25\,km) ERA5/CAMS drivers and 1\,km satellite-derived
PM\textsubscript{2.5} and elevation through a cross-resolution
attention fusion, producing a 1\,km next-day forecast over Europe
that is validated against independent EEA ground stations.}
\label{fig:concept}
\end{figure}

\paragraph{Scope and roadmap.}
The overall approach is summarised in Figure~\ref{fig:concept}.
