...
A locked dependency set (\texttt{requirements.lock}) gives an exact
reproduction of the development environment. Two Docker images
(\texttt{cranpm/cuda:0.1.0}, \texttt{cranpm/rocm:0.1.0}) provide
hermetic runtimes including system-level dependencies. The CUDA
image is published on Docker Hub; the ROCm image targets LUMI's
ROCm 6.0.3.
